...
UUID=${UUID:-'6b1d7a96-e150-43cd-9bfa-a1e790f0fc4f'}
VMESS_WSPATH=${VMESS_WSPATH:-'/6b1d7a96-e150-43cd-9bfa-a1e790f0fc4f-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/6b1d7a96-e150-43cd-9bfa-a1e790f0fc4f-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/6b1d7a96-e150-43cd-9bfa-a1e790f0fc4f-trojan'}
SS_WSPATH=${SS_WSPATH:-'/6b1d7a96-e150-43cd-9bfa-a1e790f0fc4f-shadowsocks'}
